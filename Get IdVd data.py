...
# 指令
importfile = "E:\融合2\实验数据\晶体管钝化前20250402\IdVd [(1) ; 2025_3_31 18_02_18].csv" #读取文件路径
...
for index, row in df.iterrows():
    if row[0] == 'DataValue' and float(row[x_col]) != 0:
        # 把数据添加到列表
        ...
        if x_data and y_data:
            plt.semilogy(x_data, y_data, label=f'Vg={cycle_num-1}V')

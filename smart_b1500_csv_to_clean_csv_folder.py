...
from smart_b1500_csv_to_clean_csv_dynamic_cols_forRRAM import process_csv # 导入已修改的动态列处理函数,注意有dynamic和没有dynamic的区别
...
if __name__ == "__main__":
    # 在这里设置你要处理的文件夹路径
    target_directory = r"E:\融合2\实验数据\2026-02-03-Graphene"
